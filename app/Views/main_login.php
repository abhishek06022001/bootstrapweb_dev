...
<body>
    ...
    <main>
        <div class="parent">
            <div class="card card1" style="width: 22rem; height: 50vh; background-color: white; border-radius: 10px;">
                <div class="card-body">
                    <div class="card card2" style="width: 18rem;height: 22vh;">
                    ...
                    <form  action="<?= base_url('login') ?>" method="POST">
                        ...
                        <button type="submit" style="width: 100%; background-color: #d81b60; color: white;border-radius: 3px;border: none;">Sign in </button>
                      </form>
                </div>
              </div>
        </div>
